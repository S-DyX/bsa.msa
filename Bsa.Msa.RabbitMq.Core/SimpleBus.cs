...
{
	public class SimpleBusNew : ISimpleBus
	{
		private readonly ISimpleConnection _simpleConnection;
		private readonly ILocalLogger _logger;
		private readonly ISerializeService _serializeService;

		public SimpleBusNew(ISimpleConnection simpleConnection, ILocalLogger logger, ISerializeService serializeService)
		{
			_simpleConnection = simpleConnection;
			_logger = logger;
			_serializeService = serializeService ?? new SerializeService();
		}
		public SimpleBusNew(ISimpleConnection simpleConnection, ILocalLogger logger)
			: this(simpleConnection, logger, null)
		{
		}

		public SimpleBusNew(ISimpleConnection simpleConnection)
